    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
              <a href="Pages/Quotation/quotation.php" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                  <a href="Pages/Customer portal Management/CustomerDetails.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Customer</p>
                </a>
              </li>
              <li class="nav-item">
                  <a href="Pages/Customer portal Management/ProductMaintenance.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Product</p>
                </a>
              </li>
         ...
         <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                  <a href="Pages/Customer portal Management/CustomerCompanyUpdate.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Company details</p>
                </a>
              </li>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <!-- /.chart-responsive --><div class="col-md-4">
