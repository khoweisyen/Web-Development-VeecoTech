...
<head>
  ...
  <title>Invoice System | Admin </title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                  <a href="Pages/Company Management/Companies Details.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Companies Details</p>
                </a>
              </li>
              <li class="nav-item">
                  <a href="Pages/Company Management/UpdateCompany.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Companies Update</p>
                </a>
              </li>
            </ul>
          </li>
            ...
            <!--Logut Nav-->
          <li class="nav-item">
              <a href="../InvoiceSystemNew/login.php" class="nav-link">
...
<!-- Bootstrap 4 -->
<script src="../InvoiceSystem/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- Morris.js charts -->
