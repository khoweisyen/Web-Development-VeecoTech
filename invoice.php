...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      To,<br />
                        ...
                        <input type="text" name="order_receiver_name" id="order_receiver_name" class="form-control input-sm" placeholder="Enter Receiver Name" style="margin-top:5px" />
                        <textarea name="order_receiver_address" id="order_receiver_address" class="form-control" placeholder="Enter Billing Address" style="margin-top:10px"></textarea>
                    </div>
                    <div class="col-md-4">
                     
                      <input type="text" name="order_no" id="order_no" class="form-control input-sm" placeholder="Enter Invoice No." style="margin-top:45px" />
                      <input type="text" name="order_date" id="order_date" class="form-control input-sm" placeholder="Select Invoice Date" style="margin-top:10px"/>
                    </div>
                  </div>
                  <br />
      ...
      <h3 align="center">Invoice System VeecoTech Sdn.Bhd</h3>
